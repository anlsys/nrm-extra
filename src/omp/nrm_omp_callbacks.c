...
void nrm_ompt_callback_task_create_cb(ompt_data_t *encountering_task_data, const ompt_frame_t *encountering_task_frame, ompt_data_t *new_task_data, int flags, int has_dependences, const void *codeptr_ra)
{
}

void nrm_ompt_callback_dependences_cb(ompt_data_t *task_data, const ompt_dependence_t *deps, int ndeps)
{
}

void nrm_ompt_callback_task_dependence_cb(ompt_data_t *src_task_data, ompt_data_t *sink_task_data)
{
}
...
void nrm_ompt_callback_mutex_acquire_cb(ompt_mutex_t kind, unsigned int hint, unsigned int impl, ompt_wait_id_t wait_id, const void *codeptr_ra)
{
}

void nrm_ompt_callback_nest_lock_cb(ompt_scope_endpoint_t endpoint, ompt_wait_id_t wait_id, const void *codeptr_ra)
{
}

void nrm_ompt_callback_flush_cb(ompt_data_t *thread_data, const void *codeptr_ra)
{
}

void nrm_ompt_callback_cancel_cb(ompt_data_t *task_data, int flags, const void *codeptr_ra)
{
}

void nrm_ompt_callback_device_initialize_cb(int device_num, const char *type, ompt_device_t *device, ompt_function_lookup_t lookup, const char *documentation)
{
}
...
void nrm_ompt_callback_device_load_cb(int device_num, const char *filename, int64_t offset_in_file, void *vma_in_file, size_t bytes, void *host_addr, void *device_addr, uint64_t module_id)
{
}
...
void nrm_ompt_callback_target_data_op_cb(ompt_id_t target_id, ompt_id_t host_op_id, ompt_target_data_op_t optype, void *src_addr, int src_device_num, void *dest_addr, int dest_device_num, size_t bytes, const void *codeptr_ra)
{
}

void nrm_ompt_callback_target_cb(ompt_target_t kind, ompt_scope_endpoint_t endpoint, int device_num, ompt_data_t *task_data, ompt_id_t target_id, const void *codeptr_ra)
{
}

void nrm_ompt_callback_target_map_cb(ompt_id_t target_id, unsigned int nitems, void **host_addr, void **device_addr, size_t *bytes, unsigned int *mapping_flags, const void *codeptr_ra)
{
}

void nrm_ompt_callback_target_submit_cb(ompt_id_t target_id, ompt_id_t host_op_id, unsigned int requested_num_teams)
{
}

int nrm_ompt_callback_control_tool_cb(uint64_t command, uint64_t modifier, void *arg, const void *codeptr_ra)
{
}
